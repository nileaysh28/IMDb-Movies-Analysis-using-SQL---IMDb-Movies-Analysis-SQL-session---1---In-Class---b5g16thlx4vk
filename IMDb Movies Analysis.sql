...
-- Hrithik Roshan is by far the most loved actor in Bollywood. Bollywood should consider the fan following and talent of the actor. He could be the right choice for the more diverse rolls for upcomming projects.
-- December can be the good time to release the movie. As data shows it is the time when less movies get released overall. This is also the time when most of the working officials get hollidays.
-- Colour Yellow Productions is one of the most successful Production Companies Bollywood have right now. Their network and campain stratagies for promotion of movies can have significant impact on movies success.